...
namespace ImGuiNET
{
    public unsafe class IO
    {
        ...
        {
            get { return new Vector2(_nativePtr->DisplaySize.X, _nativePtr->DisplaySize.Y); }
            set { _nativePtr->DisplaySize = value.ToNumericsVector2(); }
        }
        ...
        {
            get { return new Vector2(_nativePtr->DisplayFramebufferScale.X, _nativePtr->DisplayFramebufferScale.Y); }
            set { _nativePtr->DisplayFramebufferScale = value.ToNumericsVector2(); }
        }
        ...
        {
            get { return new Vector2(_nativePtr->MousePos.X, _nativePtr->MousePos.Y); }
            set { _nativePtr->MousePos = value.ToNumericsVector2(); }
        }
